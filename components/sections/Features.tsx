...
const FeatureItem = ({ icon, title, description, index }: FeatureItemProps) => {
  ...
  const iconContainerStyle: CSSProperties = {
    ...
    overflow: "hidden",
    position: "relative",
    background: `linear-gradient(135deg, rgba(124, 58, 237, ${
      (index % 3) * 0.05 + 0.1
    }) 0%, rgba(75, 159, 255, ${(index % 3) * 0.03 + 0.08}) 100%)`,
  };
  ...
  const overlayStyle: CSSProperties = {
    ...
    right: 0,
    bottom: 0,
    background: `linear-gradient(135deg, rgba(124, 58, 237, 0.${
      (index % 3) + 1
    }) 0%, rgba(75, 159, 255, 0.${(index % 2) + 1}) 100%)`,
    opacity: 0,
  ...
  return (
    ...
    >
      <motion.div style={featureBoxStyle}>
        <motion.div style={overlayStyle} whileHover={{ opacity: 0.1 }} />
        ...
        <motion.div
          ...
          whileHover={{
            ...
            boxShadow: `0 0 20px rgba(${
              index % 2 === 0 ? "124, 58, 237" : "var(--primary-rgb)"
            }, 0.3)`,
          }}
        >
          <motion.div style={iconGlowStyle} whileHover={{ opacity: 0.8 }} />
          <motion.div
...
export default function Features() {
  ...
  const colorShiftGlowStyle: CSSProperties = {
    ...
    height: "120%",
    background:
      "linear-gradient(90deg, rgba(124, 58, 237, 0.1), rgba(75, 159, 255, 0.1), rgba(124, 58, 237, 0.1))",
  ...
  const backgroundParticles = [
    ...
    { width: 2.2, height: 2.2, top: 66.07, left: 90.36 },
    { width: 2.59, height: 2.76, top: 47.77, left: 84.07 },
    { width: 1.53, height: 2.9, top: 65.98, left: 64.96 },
    { width: 3.88, height: 1.92, top: 28.67, left: 47.2 },
    { width: 1.57, height: 3.19, top: 58.23, left: 6.81 },
    { width: 2.22, height: 2.29, top: 94.55, left: 55.8 },
  ...
  const featuresList: Feature[] = [
    {
      ...
      description:
        "Supercharge your content marketing with cutting-edge generative AI. Effortlessly create AI avatars, social media updates, all while maintaining a consistent brand voice and personalization.",
      icon: "palette",
    },
    {
      title: "AI Powered Conversational Agent",
      description:
        "Provide round-the-clock customer engagement with advanced LLMs. Our voice AI agents seamlessly handle FAQs, assist customers in navigating products or services, and capture leads.",
      icon: "phone",
    },
    {
      title: "Real-Time Collaboration",
      description:
        "Streamlined workflows that enable teams to work together effectively from anywhere in the world.",
      icon: "users",
    },
    {
      title: "24/7 Expert Support",
      description:
        "Dedicated technical assistance from our team of specialists whenever you need it, day or night.",
      icon: "headset",
    },
  ];
    ...
    <section id="features" style={sectionStyle}>
      ...
      <div style={backgroundElementsStyle}>
        <div
          style={{
            ...
            height: "50%",
            background:
              "radial-gradient(circle at 50% 100%, rgba(var(--primary-rgb), 0.05) 0%, transparent 70%)",
          }}
        ></div>
      ...
      <div style={containerStyle}>
        <div style={headerStyle}>
          ...
          >
            Discover how our{" "}
            <span style={subtitleAccentStyle}>
              cutting-edge solutions
            </span>{" "}
            can transform your business with these powerful features designed
